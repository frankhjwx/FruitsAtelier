...
public sealed partial class EditorView
{
    ...
    private bool RatingEditInProgress => SliderConversionBusy || draftTrack != Guid.Empty || draftBanana != Guid.Empty
        || drag is DragKind.Objects or DragKind.Droplet or DragKind.Anchor or DragKind.HandleIn or DragKind.HandleOut or DragKind.DraftHandle or DragKind.BananaStart or DragKind.BananaEnd;
