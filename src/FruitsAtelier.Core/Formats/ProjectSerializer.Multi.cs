...
public static partial class ProjectSerializer
{
    ...
    public static BeatmapProject ReadProject(string text, string? projectPath = null)
    {
        ...
        try
        {
            ...
            if (json.RootElement.TryGetProperty("SchemaVersion", out var version) && version.TryGetInt32(out int schema) && schema is 1 or 3 or 5)
            ...
            if (file?.SchemaVersion is not (2 or 4 or 6) || file.Project is null) throw new InvalidDataException(L.Get("core.project.schema"));
