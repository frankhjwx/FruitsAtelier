...
- **Timing 编辑**：编辑红线和绿线、打拍定速、试听采样及重新吸附物件，支持撤销；独立 Timing 页面提供节拍器，按住 Ctrl 按当前细分播放 tick。
- **音乐与预览**：播放 MP3、OGG、WAV 及打击音，支持 10%、25%、50%、75%、100% 和 150% 速度播放；使用皮肤及 NM、Easy、Hard Rock 设置预览谱面。
...
支持读取 v12-v14 及兼容 stable 的 lazer v128 Catch `.osu`，导出为 v14。0.9 暂不提供视频和故事板播放。
...
保存工程可保留滑条和各难度的可编辑数据，导出则生成供 osu! 使用的 `.osu`。难度通过导出关联文件后，**Ctrl+S 也会更新关联的 `.osu`**；**Ctrl+Alt+E** 打开导出选项。
